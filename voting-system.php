...
$_SESSION['voted'] = 0;
$_SESSION['status'] = 'not voted';
$_SESSION['phone'] = '1234567890';
$_SESSION['fname'] = 'Mayesha';
$_SESSION['lname'] = 'Kader';
$_SESSION['idcard'] = 'path/to/idcard.jpg';
$_SESSION['otp'] = null;

// Hardcoded voting data
$voting_title = 'Presidential Election';
$vot_start_date = '2023-06-01 08:00:00';
$vot_end_date = '2023-06-01 18:00:00';

// Check if the user is already logged in and has voted
...
<body>
    <div class="container">
        ...
        <div id="profile-panel">
            ...
            <div class="link"><a href="includes/user-logout.php" class="del">
