...
<body>
   <div class="container">
        ...
        <form action="votemat_register_data.php" method="POST" enctype="multipart/form-data">
            <div class="form">
                ...
                <div class="link1">Already have account ? <a href="votemat_index.php">Login here</a></div>
            </div>
        </form>
   </div> 
   <p class="msg"></p>
